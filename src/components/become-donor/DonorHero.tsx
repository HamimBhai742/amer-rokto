export default function DonorHero() {
  return (
    <div className="relative bg-gradient-to-br from-[#8B0000] via-[#CC0000] to-[#FF2222] overflow-hidden">
      ...
      {/* Floating drops */}
      {[
        { top: "12%", left: "6%",  size: 28, delay: "0s" },
        { top: "60%", left: "92%", size: 18, delay: "1.4s" },
        { top: "25%", left: "88%", size: 14, delay: "0.7s" },
      ].map((d, i) => (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        <div className="text-center text-white">
          <div className="inline-flex items-center gap-2 bg-white/15 border border-white/25 rounded-full px-4 py-1.5 text-sm font-medium mb-4">
            ...
            বিনামূল্যে নিবন্ধন · মাত্র ৫ মিনিট
          </div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-3 tracking-tight">
            একজন <span className="text-yellow-300">স্বেচ্ছাসেবী</span> ডোনার হন
          </h1>
          <p className="text-white/80 text-base sm:text-lg max-w-xl mx-auto">
            আপনার রক্তদান কারো জীবন বাঁচাতে পারে। আজই নিবন্ধন করুন এবং
            বাংলাদেশের বৃহত্তম রক্তদান নেটওয়ার্কের অংশ হন।
          </p>
        </div>
      </div>
